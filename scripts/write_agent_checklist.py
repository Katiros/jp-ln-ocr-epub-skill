...
CHECKS = [
    ...
    ("ocr_ruby_candidates_grouped", "logs/ruby_candidates_grouped.csv", "OCR 后应存在。合并相邻振假名，方便人工审阅。"),
    ...
    ("review_ruby_grouped", "08_review/ruby_candidates_grouped.csv", "review-pack 后应存在。优先审阅的合并振假名表。"),
